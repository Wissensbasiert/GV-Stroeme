...
(function () {
  ...
  const NST_DIVISIONS_20 = {
    "01": "01 Erzeugnisse der Land- und Forstwirtschaft sowie der Fischerei",
    "02": "02 Kohle, rohes Erdöl und Erdgas",
    "03": "03 Erze, Steine und Erden, sonstige Bergbauerzeugnisse",
    "04": "04 Nahrungs- und Genussmittel",
    "05": "05 Textilien, Bekleidung, Leder und Lederwaren",
    "06": "06 Holzwaren, Papier, Pappe, Druckerzeugnisse",
    "07": "07 Kokerei- und Mineralölerzeugnisse",
    "08": "08 Chemische Erzeugnisse etc.",
    "09": "09 Sonstige Mineralerzeugnisse (Glas, Zement, Gips etc.)",
    "10": "10 Metalle und Metallerzeugnisse",
    "11": "11 Maschinen und Ausrüstungen, Haushaltsgeräte etc.",
    "12": "12 Fahrzeuge",
    "13": "13 Möbel, Schmuck, Musikinstrumente, Sportgeräte etc.",
    "14": "14 Sekundärrohstoffe, Abfälle",
    "15": "15 Post, Pakete",
    "16": "16 Geräte und Material für die Güterbeförderung",
    "17": "17 Umzugsgut und sonstige nichtmarktbestimmte Güter",
    "18": "18 Sammelgut",
    "19": "19 Gutart unbekannt",
  ...
  function hasUsableMapLocation(region) {
    return Number.isFinite(Number(region?.lat)) && Number.isFinite(Number(region?.lng));
  }

  function mapLocationBadge(partnerId) {
    if (hasUsableMapLocation(fullCentroids[partnerId] || regionsData[partnerId])) return '';
    return ' <span class="relation-location-note" title="Für diese Partnerregion liegt keine räumlich belastbare Koordinate vor. Die Relation wird in der Tabelle berücksichtigt, aber ohne Kartenlinie dargestellt.">ohne Kartenpunkt</span>';
  }
  ...
  function renderMapSpiderLines(mapKey, modeFilter = null, groupFilter = 'ALL') {
    ...
    if (!hasUsableMapLocation(regMeta)) {
      if (spiderSec) spiderSec.style.display = 'none';
      return;
    }
    ...
    topFlows.forEach(r => {
      ...
      if (!hasUsableMapLocation(pMeta)) return;
