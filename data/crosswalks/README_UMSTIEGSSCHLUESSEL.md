...
`scripts/validation/validate_vp2040_bundle.py` ist der verbindliche Abnahmetest. Er bricht bei einer unvollständigen oder doppelten Codeliste, einer fachlichen Differenz zwischen CSV und JSON, einer von der NST-Abteilung abweichenden C-Gruppe, abweichenden C-Gruppenbezeichnungen oder einem nicht belegbaren VP-Begriff ab. Erst danach werden die VP-Rohmatrizen gegen das erzeugte Dashboard-Paket nachgerechnet.
