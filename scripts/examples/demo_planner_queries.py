...
summary_parquet = (ROOT / "data" / "processed" / "fact_regional_summary.parquet").as_posix()
od_parquet = (ROOT / "data" / "processed" / "fact_od_flows.parquet").as_posix()
centroids_file = ROOT / "data" / "processed" / "nuts_centroids.json"
