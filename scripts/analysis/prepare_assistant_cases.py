...
EXECUTABLE = {
    ...
    'T21': ('rail_goods_history', {'region':'DEA23','partner':'DE600','years':[2023,2024],'direction':'outbound','metric':'tonnes','classification':'C7'}),
    ...
    'T44': ('rail_goods', {'region':'DEA23','partner':'DE600','year':2024,'direction':'outbound','group':'ALL','classification':'C7','metric':'tonnes'}),
    ...
    'T19': ('rail_goods', {'region': 'DEA23', 'partner': 'DE600', 'year': 2024, 'direction': 'outbound', 'group': 'ALL', 'classification': 'C7', 'metric': 'tonnes'}),
