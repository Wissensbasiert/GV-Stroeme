...
(async()=>{
 ...
 await page.mouse.move(0,0);await page.waitForTimeout(400);await page.locator('#enlarge-chartTollDistanceClasses').click();await page.locator('#modalChartLarge.active').waitFor();assert.match(await page.locator('#largeChartContext').innerText(),/Diagrammwerte: %/);await page.keyboard.press('Escape');
