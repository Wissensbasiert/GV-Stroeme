...
**Aufbewahrung noch offen:** Die abschließende Inventur bestätigt `air01` als aktiven und einzig durch Site/Aufgaben geschützten Release, gesunde Anwendung und unveränderte Produktion. `retention_plan.json` sieht `nodes02` und `scope01` als zwei Rückfallstände vor. Acht ältere Releases einschließlich des bekannten unbrauchbaren `nodes01` wären zu entfernen. Die automatische Freigabeprüfung hat den Bereinigungsaufruf vor Ausführung wegen fehlender ausdrücklicher Löschfreigabe abgelehnt. Es wurde nichts gelöscht; weiterhin elf Releases vorhanden. Vor einer späteren Bereinigung Inventur/Plan neu erstellen und alle drei erhaltenen Bestände vollständig prüfen. Der fertige Testrelease ist von dieser offenen Aufräumarbeit unabhängig.
