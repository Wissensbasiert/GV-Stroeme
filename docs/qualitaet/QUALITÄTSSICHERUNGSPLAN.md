...
**Lokal geprüft, 15.09.2026 – Analyseassistent 0.8.1:** Die öffentliche Schienen-Güterauswertung verwendet ausschließlich benannte C7-Gruppen oder zweistellige NST-2007-Abteilungen. Dreistellige NST-Feinpositionen bleiben intern. Anschlussfragen nach Entwicklung, Gewinn oder Verlust übernehmen Relation, Richtung, Kennzahl und bestätigte Randjahre. Der reproduzierte Berlin–Hamburg-Fall 2021–2025 sowie C7-/NST-20-Darstellung, Verträge und semantische Auswahl sind lokal ohne externen Modellaufruf geprüft. Datenbestände, Testportal und Produktion unverändert. [Prüfbericht](ANALYSEASSISTENT_SCHIENENGÜTERGRUPPEN_20260915.md).
