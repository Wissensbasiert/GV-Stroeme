...
**Testportal, 15.09.2026 – Analyseassistent 0.8.1 (`groups01`):** Die öffentliche Schienen-Güterauswertung verwendet ausschließlich benannte C7-Gruppen oder zweistellige NST-2007-Abteilungen. Dreistellige NST-Feinpositionen bleiben intern. Anschlussfragen nach Entwicklung, Gewinn oder Verlust übernehmen Relation, Richtung, Kennzahl und bestätigte Randjahre. Der reproduzierte Berlin–Hamburg-Fall 2021–2025 sowie C7-/NST-20-Darstellung, Verträge und semantische Auswahl sind lokal und im aktiven Linux-Release ohne externen Modellaufruf geprüft. Alle 1.784 Serverdateien, API, Datenbank und das angemeldete Dashboard wurden bestätigt; Produktion unverändert. [Prüfbericht](ANALYSEASSISTENT_SCHIENENGÜTERGRUPPEN_20260915.md).

**Testportal, 15.09.2026 – Analyseassistent 0.8.0 (`total01`):** Die Prognoserangliste verarbeitet einen oder mehrere ausdrücklich gebundene Verkehrsträger. Gesamtformulierungen werden serverseitig gegen Straße, Schiene und Binnenschiff abgesichert; bei einer neuen, tatsächlich unklaren Rangfrage wird statt einer willkürlichen Einzelauswahl nachgefragt. Der Ladekreis im Antwortbereich bleibt bis zum Abschluss der Anfrage sichtbar, ohne den Livestream zu ersetzen. B04–B06 und die abhängigen privaten Bestände wurden neu aufgebaut; 221/221 lokale Laufzeittests, Releaseprüfung aller 1.784 Dateien, Linux-Daten-/Datenbankprüfung und synthetische Browserprüfung bestanden. Keine externen Modellaufrufe; Produktion unverändert. [Prüfbericht](ANALYSEASSISTENT_GESAMTRANKING_UND_LADEANZEIGE_20260915.md).

**Testportal, 15.09.2026:** Diagrammspezifische Kopfzeilen, regionale KV-Struktur und verzögerte Ladeanzeige sind im gemeinsamen Release `total01` bereitgestellt. 228 Quellenkontrollen, 25 Browseransichten und bestehende Export-/Lade-/Luft-KPI-Prüfungen bestanden. [Prüfbericht und Grenzen](DIAGRAMMKONTEXT_UND_KV_20260915.md).
