...
**Nachtrag 11.09.2026 – geführtes Analysegespräch und korrigierte Gütergliederung:** `portal-test-20260911-gueterstroeme-beta03` ist auf Testsite 1067000 aktiv. 78 lokale Prüfungen, der begrenzte echte Sechs-Eingaben-Vergleich des Dialogausbaus, ein zusätzlicher echter Modelllauf zur Güterdarstellung, alle 1.706 Serverdateien und die Linux-Laufzeit bestehen. Die frühere Sichtprüfung übersah sieben Güterarten und überlappende NST-Positionen in derselben Tabelle; der Nutzerbefund wurde bestätigt und behoben. Tabelle und Sprachbelege zeigen nun bei einer Standardfrage sieben Güterarten plus Summe. Angemeldete Liveprüfung: Berlin → Hamburg 2025, 2.010 und 238.287 Tonnen, Summe 240.297 Tonnen, keine NST-Zeilen; Verbrauch 5/50 → 6/50. Interne Einzelfakten bleiben vollständig. Verfügbarkeitskatalog, signierter Stand, Beta-Kennzeichnung, Hover und entfernter technischer Antwortbereich bleiben erhalten. [Vollständiger begrenzter Nachweis](ANALYSEASSISTENT_BETA_20260911.md). Keine Produktionsfreigabe oder fachliche Gesamtabnahme beliebiger Fragen.

**Stand:** 11.09.2026

Ergänzungen zum Analyseassistenten vom 09.–11.09.2026 stehen am Dokumentende. Das eigene Testkonto ist freigeschaltet und der Beta03-Browser-/Kontingenttest bestanden. Die lokale Version 0.2.1 mit Mehrjahresrelation, analytischen Kernaussagen und rechnerischen Veränderungen ist noch nicht neu bereitgestellt. Für B01–B06 ist der letzte Nachprüfungsabschnitt maßgeblich; frühere Paketabschnitte dokumentieren die jeweiligen Vorgängerstände.
...
**Prüfung:** `outputs/analyseassistent_runtime_20260911/narrative_validation01.json` bestätigt 77/77 lokale Laufzeit-, Daten-, Sicherheits- und Dialogprüfungen, null externe Modellaufrufe. Darin enthalten sind beide Rosenheim–Augsburg-Abläufe, der analytische Duisburg-Güter- und Regionsprofil-Einstieg, sicherer Datenfehler sowie Ablehnung fremder Kennungen, neuer Zahlen, geänderter Einheiten und unbelegter wirtschaftlicher Deutungen. Ein zusätzlicher lokaler Stichprobenlauf über zwölf strukturierte Katalogfälle erzeugte bei allen numerischen Fällen mindestens eine Analyseaussage; große Tabellen waren eingeklappt. Python- und JavaScript-Syntax sowie der vollständige Frontend-Neubau bestehen. Die Datenbestände wurden nicht geändert.

**Freigabegrenze:** Dies ist eine lokale Programm- und Subagentenprüfung, kein neuer Requesty-45-Fälle-Lauf und keine Liveabnahme. Der aktive Testrelease ui10 verwendet weiterhin die vorherige Antwortlogik. Vor einer Freigabe sind ein neuer Testrelease, ein kleiner echter Modell-Stichprobenlauf und der angemeldete Browsernachweis erforderlich; Produktion bleibt unverändert.
