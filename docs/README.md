...
**Testportal, 15.09.2026 – Analyseassistent 0.8.1 (`groups01`):** Schienen-Gütergruppen erscheinen standardmäßig als sieben benannte C7-Gruppen, bei ausdrücklicher NST-Frage als 20 benannte NST-2007-Abteilungen. Dreistellige Feinpositionen bleiben intern; Entwicklungsfragen übernehmen die bestätigten Randjahre. Vollständige Release-/Linux-Prüfung und angemeldete Browser-Sichtprüfung bestanden, ohne externen Modellaufruf. [Prüfbericht](qualitaet/ANALYSEASSISTENT_SCHIENENGÜTERGRUPPEN_20260915.md).
