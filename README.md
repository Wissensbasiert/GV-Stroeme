...
**Testportal, 15.09.2026 – Analyseassistent 0.8.1 (`groups01`):** Schienenrelationen zeigen standardmäßig die sieben benannten C7-Gütergruppen wie im Dashboard und auf ausdrücklichen Wunsch die 20 benannten NST-2007-Abteilungen. Dreistellige NST-Feinpositionen werden nicht ausgegeben. Anschlussfragen nach Entwicklung, Gewinnen oder Verlusten vergleichen die bestätigten Randjahre. Der aktive Linux-Bestand, die API und Datenbank sowie das angemeldete Dashboard wurden geprüft; keine externen Modellaufrufe. [Prüfbericht](docs/qualitaet/ANALYSEASSISTENT_SCHIENENGÜTERGRUPPEN_20260915.md).
